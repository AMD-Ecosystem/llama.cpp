...
#ifndef HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_PADWAIT_WAIT12312
...
#ifndef HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_COPY_NOMEM
#define HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_COPY_NOMEM 0
#endif

#ifndef HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_FORCE_PREWAIT
#define HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_FORCE_PREWAIT 0
#endif

#ifndef HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_RING12_ALIAS
#define HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_RING12_ALIAS 0
#endif
...
#ifndef HRX_Q6_K_WMMA_VK128_W64_COMPACT_ACC
#define HRX_Q6_K_WMMA_VK128_W64_COMPACT_ACC 0
#endif
...
#ifndef HRX_Q6_K_WMMA_VK128_FULL_TILE_STAGE_STORE
...
#ifndef HRX_Q6_K_WMMA_VK128_P33_STAGE_TAIL_STORE
#define HRX_Q6_K_WMMA_VK128_P33_STAGE_TAIL_STORE 0
#endif

#ifndef HRX_Q6_K_WMMA_VK128_P33_STAGE12_STORE
...
#ifndef HRX_Q6_K_WMMA_VK128_STORE_RADV96_DUPLICATE
...
#ifndef HRX_Q6_K_WMMA_VK128_STORE_ACC8_MAPPED_DIRECT8
...
#ifndef HRX_Q6_K_WMMA_VK128_STORE_RADV96_COMPACT_RAWBUF_HELPER4
#define HRX_Q6_K_WMMA_VK128_STORE_RADV96_COMPACT_RAWBUF_HELPER4 0
#endif
...
typedef uint32_t hrx_q6_k_wmma_vk128_u32x4_vec __attribute__((ext_vector_type(4)));
...
static __device__ __forceinline__ hrx_q6_k_wmma_vk128_half16_vec hrx_q6_k_wmma_vk128_copy_frag_nomem(
        hrx_q6_k_wmma_vk128_half16_vec frag) {
    const hrx_q6_k_wmma_vk128_u32x8_vec in = __builtin_bit_cast(hrx_q6_k_wmma_vk128_u32x8_vec, frag);
    hrx_q6_k_wmma_vk128_u32x8_vec out;
    asm volatile("v_mov_b32 %0, %8\n\t"
...
static __device__ __forceinline__ hrx_q6_k_wmma_vk128_u32x4_vec hrx_q6_k_wmma_vk128_wmma_f16_w64_compact(
        hrx_q6_k_wmma_vk128_half16_vec a_frag,
        hrx_q6_k_wmma_vk128_half16_vec b_frag,
...
static __device__ __forceinline__ _Float16 hrx_q6_k_wmma_vk128_compact_acc_selected(
        hrx_q6_k_wmma_vk128_u32x4_vec acc,
        int reg) {
    return hrx_q6_k_wmma_vk128_u16_to_f16(acc[reg] & 0xffffu);
}
#endif
...
#if HRX_Q6_K_WMMA_VK128_W64_COMPACT_ACC
static __device__ __forceinline__ void hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_compact_buffer(
        __amdgpu_buffer_rsrc_t dst_rsrc,
        long long rows_stride,
        long long row0,
        long long col0,
    ...
    for (int reg = 0; reg < 4; ++reg) {
        ...
        if (row < rows) {
            hrx_q6_k_wmma_vk128_buffer_store_f32(
                dst_rsrc,
                col * rows_stride + row,
                static_cast<float>(hrx_q6_k_wmma_vk128_compact_acc_selected(acc, reg)));
        }
    }
}

#if HRX_Q6_K_WMMA_VK128_STORE_RADV96_COMPACT_RAWBUF_HELPER4
static __device__ __forceinline__ void hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_compact_buffer4(
        __amdgpu_buffer_rsrc_t dst_rsrc,
        long long rows_stride,
        long long row_base,
        long long col_base,
...
#define HRX_Q6_K_WMMA_VK128_RAWBUF_STORE_ONE(idx, acc_value) \
    do { \
        const int group = group_base + (idx); \
    ...
    HRX_Q6_K_WMMA_VK128_RAWBUF_STORE_ONE(0, acc0);
    HRX_Q6_K_WMMA_VK128_RAWBUF_STORE_ONE(1, acc1);
    HRX_Q6_K_WMMA_VK128_RAWBUF_STORE_ONE(2, acc2);
    HRX_Q6_K_WMMA_VK128_RAWBUF_STORE_ONE(3, acc3);
#undef HRX_Q6_K_WMMA_VK128_RAWBUF_STORE_ONE
}
#endif
#endif
#endif
...
#if (HRX_Q6_K_WMMA_VK128_FULL_TILE_STAGE_STORE || HRX_Q6_K_WMMA_VK128_P33_STAGE_TAIL_STORE || HRX_Q6_K_WMMA_VK128_STORE_STAGE_DUAL_HALF || HRX_Q6_K_WMMA_VK128_STORE_STAGE_FAST_HALF || HRX_Q6_K_WMMA_VK128_SIDE_STAGE_FAST_HALF || HRX_Q6_K_WMMA_VK128_MIXED_DIRECT_FAST_HALF) && HRX_Q6_K_WMMA_VK128_BUFFER_STORE
...
#if HRX_Q6_K_WMMA_VK128_FULL_TILE_STAGE_STORE
static __device__ __forceinline__ void hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_stage_full_buffer(
        __amdgpu_buffer_rsrc_t dst_rsrc,
        long long rows_stride,
        long long row0,
        long long col0,
...
#pragma unroll
    ...
    const _Float16 h0 = hrx_q6_k_wmma_vk128_u16_to_f16(
        hrx_q6_k_wmma_vk128_ds_load_u16_d16(sh_store + col_major_base + 0));
    const _Float16 h1 = hrx_q6_k_wmma_vk128_u16_to_f16(
        hrx_q6_k_wmma_vk128_ds_load_u16_d16(sh_store + col_major_base + 4));
    const _Float16 h2 = hrx_q6_k_wmma_vk128_u16_to_f16(
        hrx_q6_k_wmma_vk128_ds_load_u16_d16(sh_store + col_major_base + 8));
    const _Float16 h3 = hrx_q6_k_wmma_vk128_u16_to_f16(
        hrx_q6_k_wmma_vk128_ds_load_u16_d16(sh_store + col_major_base + 12));
    asm volatile("s_waitcnt lgkmcnt(0)\n" ::: "memory");

    const int byte_offset = static_cast<int>(
        ((col0 + static_cast<long long>(col_lane)) * rows_stride + row0 + static_cast<long long>(row_lane)) *
        static_cast<long long>(sizeof(float)));
    const int v0 = __builtin_bit_cast(int, static_cast<float>(h0));
    const int v1 = __builtin_bit_cast(int, static_cast<float>(h1));
    const int v2 = __builtin_bit_cast(int, static_cast<float>(h2));
    const int v3 = __builtin_bit_cast(int, static_cast<float>(h3));
    asm volatile(
        "s_clause 0x3\n"
        "buffer_store_b32 %0, %4, %5, 0 offen\n"
        "buffer_store_b32 %1, %4, %5, 0 offen offset:16\n"
...
#if HRX_Q6_K_WMMA_VK128_P33_STAGE16_STORE
static __device__ __forceinline__ void hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_stage_p33_all_buffer(
        __amdgpu_buffer_rsrc_t dst_rsrc,
        long long rows_stride,
        long long row0,
        long long col0,
...
#pragma unroll
    ...
    if (col < cols && row + 12 < rows) {
        const int byte_offset = static_cast<int>((col * rows_stride + row) * static_cast<long long>(sizeof(float)));
        const int v0 = __builtin_bit_cast(int, static_cast<float>(h0));
        const int v1 = __builtin_bit_cast(int, static_cast<float>(h1));
        const int v2 = __builtin_bit_cast(int, static_cast<float>(h2));
        const int v3 = __builtin_bit_cast(int, static_cast<float>(h3));
...
#if HRX_Q6_K_WMMA_VK128_P33_STAGE_TAIL_STORE
static __device__ __forceinline__ void hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_stage_tail_col0_buffer(
        __amdgpu_buffer_rsrc_t dst_rsrc,
        long long rows_stride,
        long long row0,
        long long col0,
...
#pragma unroll
    ...
    const int byte_offset = static_cast<int>(
        (col * rows_stride + row0 + static_cast<long long>(row_lane)) *
        static_cast<long long>(sizeof(float)));
    const int v0 = __builtin_bit_cast(int, static_cast<float>(h0));
    const int v1 = __builtin_bit_cast(int, static_cast<float>(h1));
    const int v2 = __builtin_bit_cast(int, static_cast<float>(h2));
...
#elif (HRX_Q6_K_WMMA_VK128_STORE_RADV96_SIDECAR || HRX_Q6_K_WMMA_VK128_STORE_RADV96_DUPLICATE || HRX_Q6_K_WMMA_VK128_STORE_Q6ADDR_UPPERDEPNOMEM) && !HRX_Q6_K_WMMA_VK128_STORE_RADV96_OVERLAY_A && !HRX_Q6_K_WMMA_VK128_STORE_RADV96_COMPACT_RAWBUF_HELPER4
...
#endif
#if (HRX_Q6_K_WMMA_VK128_STORE_RADV96_SIDECAR || HRX_Q6_K_WMMA_VK128_STORE_RADV96_DUPLICATE || HRX_Q6_K_WMMA_VK128_STORE_Q6ADDR_UPPERDEPNOMEM) && HRX_Q6_K_WMMA_VK128_STORE_RADV96_OVERLAY_A && !HRX_Q6_K_WMMA_VK128_STORE_RADV96_COMPACT_RAWBUF_HELPER4
    uint16_t * const sh_store_radv96 = reinterpret_cast<uint16_t *>(sh_a);
#endif
...
#if HRX_Q6_K_WMMA_VK128_W64_COMPACT_ACC
    hrx_q6_k_wmma_vk128_u32x4_vec acc[16] = {};
#else
...
#elif HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_PADWAIT_WAIT12312
                    if (group == 1) {
                        asm volatile("s_waitcnt lgkmcnt(36)\n" ::: "memory");
                    } else if (group == 2) {
                        asm volatile("s_waitcnt lgkmcnt(28)\n" ::: "memory");
...
#elif HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_COPY_NOMEM
                    a_use = hrx_q6_k_wmma_vk128_copy_frag_nomem(a_use);
#else
                    a_use = hrx_q6_k_wmma_vk128_copy_frag(a_use);
#endif
#endif
...
#elif HRX_Q6_K_WMMA_VK128_W64_VK64_RING96_K2_KLOOP_COPY_NOMEM
                    b_use = hrx_q6_k_wmma_vk128_copy_frag_nomem(b_use);
#else
                    b_use = hrx_q6_k_wmma_vk128_copy_frag(b_use);
#endif
#endif
...
#if HRX_Q6_K_WMMA_VK128_W64_COMPACT_ACC
                        acc[group] = hrx_q6_k_wmma_vk128_wmma_f16_w64_compact(a_dep, b_dep, acc[group]);
...
#if HRX_Q6_K_WMMA_VK128_W64_COMPACT_ACC && HRX_Q6_K_WMMA_VK128_STORE_RADV96_COMPACT_RAWBUF_HELPER4
    if (tid < 64u) {
        hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_compact_buffer4(
            dst_rsrc, rows, row_base, col_base, rows, cols, 8, lane,
            acc[8], acc[9], acc[10], acc[11]);
        hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_compact_buffer4(
            dst_rsrc, rows, row_base, col_base, rows, cols, 12, lane,
...
#pragma unroll
    for (int group = 0; group < 16; ++group) {
        if (tid < 64u) {
            ...
            hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_stage_p33_all_buffer(
                dst_rsrc,
                rows,
                tile_row0,
                tile_col0,
...
#elif HRX_Q6_K_WMMA_VK128_P33_STAGE12_STORE
            const long long tile_row0 = row_base + static_cast<long long>(row_tile * 16);
            const long long tile_col0 = col_base + static_cast<long long>(col_tile * 16);
            if (group < 12) {
                if (tile_row0 + 16 <= rows && tile_col0 + 16 <= cols) {
                    hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_stage_full_buffer(
                        dst_rsrc,
                        rows,
                        tile_row0,
                        tile_col0,
...
#if HRX_Q6_K_WMMA_VK128_P33_STAGE_TAIL_STORE
                hrx_q6_k_wmma_vk128_store_acc_f16_row_major_w64_stage_tail_col0_buffer(
                    dst_rsrc,
                    rows,
                    tile_row0,
                    tile_col0,
