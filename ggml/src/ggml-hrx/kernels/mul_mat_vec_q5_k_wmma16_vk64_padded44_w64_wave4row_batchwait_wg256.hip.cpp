...
static __device__ __forceinline__ hrx_q5_k_wmma_vk128_half16_vec
hrx_q5_k_wmma_vk64_load_a_frag_w64_b64asm_batchwait(
    ...
    const hrx_q5_k_wmma_vk128_half4_vec v0 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(row_ptr + 0);
    const hrx_q5_k_wmma_vk128_half4_vec v1 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(row_ptr + 4);
    const hrx_q5_k_wmma_vk128_half4_vec v2 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(row_ptr + 8);
    const hrx_q5_k_wmma_vk128_half4_vec v3 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(row_ptr + 12);
    asm volatile("s_waitcnt lgkmcnt(0)\n" ::: "memory");
    hrx_q5_k_wmma_vk128_half16_vec result;
    hrx_q5_k_wmma_vk128_append_half4(&result, 0, v0);
    hrx_q5_k_wmma_vk128_append_half4(&result, 4, v1);
    hrx_q5_k_wmma_vk128_append_half4(&result, 8, v2);
    hrx_q5_k_wmma_vk128_append_half4(&result, 12, v3);
    return result;
}

static __device__ __forceinline__ hrx_q5_k_wmma_vk128_half16_vec
hrx_q5_k_wmma_vk64_load_b_frag_w64_b64asm_batchwait(
    ...
    const hrx_q5_k_wmma_vk128_half4_vec v0 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(col_ptr + 0);
    const hrx_q5_k_wmma_vk128_half4_vec v1 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(col_ptr + 4);
    const hrx_q5_k_wmma_vk128_half4_vec v2 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(col_ptr + 8);
    const hrx_q5_k_wmma_vk128_half4_vec v3 = hrx_q5_k_wmma_vk128_ds_read_b64_h4_nowait(col_ptr + 12);
    asm volatile("s_waitcnt lgkmcnt(0)\n" ::: "memory");
    hrx_q5_k_wmma_vk128_half16_vec result;
    hrx_q5_k_wmma_vk128_append_half4(&result, 0, v0);
    hrx_q5_k_wmma_vk128_append_half4(&result, 4, v1);
...
static __device__ __forceinline__ void hrx_q5_k_wmma_vk64_wave4row_batchwait_store_slot(
    ...
    if (row < rows && col < cols) {
        hrx_q5_k_wmma_vk128_buffer_store_f32(
            dst_rsrc,
            col * rows_stride + row,
            static_cast<float>(acc[col_sub][slot * 2 + HRX_Q5_K_WMMA_VK128_W64_OPSEL]));
    }
}

extern "C" __global__ __launch_bounds__(256, 1)
void hrx_mul_mat_vec_q5_k_wmma16x16_vk64_padded44_w64_wave4row_batchwait_f16acc_wg256_f32(
...
#pragma unroll
        for (int slot = 0; slot < 4; ++slot) {
            hrx_q5_k_wmma_vk64_wave4row_batchwait_store_slot(
