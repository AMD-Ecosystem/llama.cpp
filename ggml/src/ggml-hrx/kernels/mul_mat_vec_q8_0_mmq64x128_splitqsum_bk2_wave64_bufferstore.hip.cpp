// Q8_0 x Q8_1 x4 prompt full-column probe: preserve the accepted
// BK2+wave64 packed scalar-dot route and change only output writeback to
// explicit raw buffer stores for static schedule comparison.
#define hrx_mul_mat_vec_q8_0_f32 hrx_mul_mat_vec_q8_0_mmq64x128_splitqsum_bk2_wave64_bufferstore_unused_f32
#define hrx_mul_mat_vec_q8_0_cols8_f32 hrx_mul_mat_vec_q8_0_cols8_mmq64x128_splitqsum_bk2_wave64_bufferstore_unused_f32
#define hrx_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_f32 hrx_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_mmq64x128_splitqsum_bk2_wave64_bufferstore_unused_f32
#define hrx_mul_mat_vec_q8_0_add_f32 hrx_mul_mat_vec_q8_0_add_mmq64x128_splitqsum_bk2_wave64_bufferstore_unused_f32
#define hrx_mul_mat_vec_q8_0_add_cols8_f32 hrx_mul_mat_vec_q8_0_add_cols8_mmq64x128_splitqsum_bk2_wave64_bufferstore_unused_f32
#define hrx_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_f32 hrx_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_mmq64x128_splitqsum_bk2_wave64_bufferstore_unused_f32
#define hrx_mul_mat_vec_q8_0_add_rows4_cols4_f32 hrx_mul_mat_vec_q8_0_add_rows4_cols4_mmq64x128_splitqsum_bk2_wave64_bufferstore_unused_f32

#include "mul_mat_vec_q8_0.hip.cpp"

static constexpr int HRX_Q8_0_MMQ_RAW_BUFFER_FLAGS_GFX11 = 0x31004000;

static __device__ __forceinline__ __amdgpu_buffer_rsrc_t hrx_q8_0_mmq_make_dst_rsrc(float * dst) {
    return __builtin_amdgcn_make_buffer_rsrc(
        dst,
        static_cast<unsigned short>(0),
        0xffffffffull,
        HRX_Q8_0_MMQ_RAW_BUFFER_FLAGS_GFX11);
}

static __device__ __forceinline__ void hrx_q8_0_mmq_buffer_store_f32(
...
extern "C" __global__ void hrx_mul_mat_vec_q8_0_q8_1_x4_mmq64x128_splitqsum_bk2_wave64_bufferstore_wg256_f32(
    ...
    const __amdgpu_buffer_rsrc_t dst_rsrc = hrx_q8_0_mmq_make_dst_rsrc(dst);
    ...
    for (int col = 0; col < COLS_PER_THREAD; ++col) {
        if (col_base + col < cols) {
            ...
            hrx_q8_0_mmq_buffer_store_f32(dst_rsrc, out_idx, sum[col]);
        }
    }
}
