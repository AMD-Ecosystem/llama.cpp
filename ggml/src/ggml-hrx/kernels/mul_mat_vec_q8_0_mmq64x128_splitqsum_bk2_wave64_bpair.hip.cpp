...
// BM64/BN128/BK2/wave64 packed path, but preload one 16-column B-cache chunk
// before issuing each qpack's dot products.
#define hrx_mul_mat_vec_q8_0_f32 hrx_mul_mat_vec_q8_0_mmq64x128_splitqsum_bk2_wave64_bpair_unused_f32
#define hrx_mul_mat_vec_q8_0_cols8_f32 hrx_mul_mat_vec_q8_0_cols8_mmq64x128_splitqsum_bk2_wave64_bpair_unused_f32
#define hrx_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_f32 hrx_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_mmq64x128_splitqsum_bk2_wave64_bpair_unused_f32
#define hrx_mul_mat_vec_q8_0_add_f32 hrx_mul_mat_vec_q8_0_add_mmq64x128_splitqsum_bk2_wave64_bpair_unused_f32
#define hrx_mul_mat_vec_q8_0_add_cols8_f32 hrx_mul_mat_vec_q8_0_add_cols8_mmq64x128_splitqsum_bk2_wave64_bpair_unused_f32
#define hrx_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_f32 hrx_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_mmq64x128_splitqsum_bk2_wave64_bpair_unused_f32
#define hrx_mul_mat_vec_q8_0_add_rows4_cols4_f32 hrx_mul_mat_vec_q8_0_add_rows4_cols4_mmq64x128_splitqsum_bk2_wave64_bpair_unused_f32

#include "mul_mat_vec_q8_0.hip.cpp"

extern "C" __global__ void hrx_mul_mat_vec_q8_0_q8_1_x4_mmq64x128_splitqsum_bk2_wave64_bpair_wg256_f32(
        ...
        for (int k_step = 0; k_step < BK_STEP; ++k_step) {
            ...
            for (int chunk = 0; chunk < COLS_PER_THREAD; chunk += COL_CHUNK) {
                ...
                for (int iqs = 0; iqs < 8; ++iqs) {
                    int b_pair[COL_CHUNK];
                    #pragma unroll
                    for (int j = 0; j < COL_CHUNK; ++j) {
                        const int col = chunk + j;
                        b_pair[j] = b_qs[k_step][col_lane * COLS_PER_THREAD + col][iqs];
                    }

                    const int qpack = hrx_q8_0_pack4(block, iqs);
                    #pragma unroll
                    for (int j = 0; j < COL_CHUNK; ++j) {
                        qsum[j] += hrx_sdot4_q8_q8_1(qpack, b_pair[j]);
                    }
                }
