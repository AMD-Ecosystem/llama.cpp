// Q8_0 x Q8_1 x4 prompt probe: keep the accepted BM64 row ownership and
// test whether splitting the temporary qsum register tile lets BN112 avoid
// the spill wall seen by the straightforward column-widened route.
#define hrx_mul_mat_vec_q8_0_f32 hrx_mul_mat_vec_q8_0_mmq64x112_splitqsum_unused_f32
#define hrx_mul_mat_vec_q8_0_cols8_f32 hrx_mul_mat_vec_q8_0_cols8_mmq64x112_splitqsum_unused_f32
#define hrx_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_wg256_f32 hrx_mul_mat_vec_q8_0_q8_1_x4_mmq128x32_mmq64x112_splitqsum_unused_f32
#define hrx_mul_mat_vec_q8_0_add_f32 hrx_mul_mat_vec_q8_0_add_mmq64x112_splitqsum_unused_f32
#define hrx_mul_mat_vec_q8_0_add_cols8_f32 hrx_mul_mat_vec_q8_0_add_cols8_mmq64x112_splitqsum_unused_f32
#define hrx_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_wg256_f32 hrx_mul_mat_vec_q8_0_add_q8_1_x4_mmq128x32_mmq64x112_splitqsum_unused_f32
#define hrx_mul_mat_vec_q8_0_add_rows4_cols4_f32 hrx_mul_mat_vec_q8_0_add_rows4_cols4_mmq64x112_splitqsum_unused_f32

#include "mul_mat_vec_q8_0.hip.cpp"

extern "C" __global__ void hrx_mul_mat_vec_q8_0_q8_1_x4_mmq64x112_splitqsum_wg256_f32(
    ...
    constexpr int COLS_PER_THREAD = 28;
    constexpr int COL_CHUNK = 14;
        ...
        for (int chunk = 0; chunk < COLS_PER_THREAD; chunk += COL_CHUNK) {
            ...
            for (int iqs = 0; iqs < 8; ++iqs) {
                ...
                for (int j = 0; j < COL_CHUNK; ++j) {
                    ...
                    qsum[j] += hrx_sdot4_q8_q8_1(qpack, b_qs[col_lane * COLS_PER_THREAD + col][iqs]);
                }
            }
