...
KERNELS = [
    ...
    {
        "name": "hrx_flash_attn_ext_f32_f16_decode_gqa4",
        "source": "flash_attn_ext_f32_f16_decode_gqa4.hip.cpp",
        "format": None,
        "binding_count": 6,
        "constants_size": 200,
        "workgroup_size": (256, 1, 1),
    ...
    {
        "name": "hrx_flash_attn_ext_f32_f16_decode_gqa4_tiled_split",
        "source": "flash_attn_ext_f32_f16_decode_gqa4_tiled_split.hip.cpp",
        "format": None,
        "binding_count": 7,
        "constants_size": 200,
        "workgroup_size": (128, 1, 1),
    ...
    {
        "name": "hrx_flash_attn_ext_f32_f16_decode_gqa4_tiled_reduce",
        "source": "flash_attn_ext_f32_f16_decode_gqa4_tiled_reduce.hip.cpp",
        "format": None,
        "binding_count": 3,
        "constants_size": 200,
        "workgroup_size": (128, 1, 1),
