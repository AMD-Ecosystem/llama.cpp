...
def kernel_executable_format(kernel, arch):
    executable_format = kernel.get("format")
    if executable_format:
        return executable_format.format(arch=arch)
    return f"amdgcn-amd-amdhsa--{arch}"
...
def main():
    ...
    for arch in args.arch:
        for kernel in KERNELS:
            ...
            entry["format"] = kernel_executable_format(kernel, arch)
