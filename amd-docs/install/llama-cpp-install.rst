...
To use llama.cpp `b5997 <https://github.com/AMD-Ecosystem/llama.cpp/tree/release/b5997>`__, you need the following prerequisites:
...
3. Clone the `https://github.com/AMD-Ecosystem/llama.cpp <https://github.com/AMD-Ecosystem/llama.cpp>`__ repository:
